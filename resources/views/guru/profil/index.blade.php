...
<section class="section">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    @else
                        <img src="{{ asset('backend/assets/compiled/jpg/1.jpg') }}" alt="Avatar" class="rounded-circle mb-3" style="width: 150px; height: 150px;">
                    @endif
                    <h4>{{ Auth::user()->name }}</h4>
                    <p class="text-muted">Guru</p>
                    
                    <!-- Form Upload Foto -->
                    <form action="{{ route('guru.profil.avatar') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h4>Data Pribadi</h4></div>
                <div class="card-body">
                    <form>
                        <div class="row mb-3">
